...
export function AboutSection() {
  return (
    <AnimatedSection id="about" className="relative w-full py-24 overflow-hidden bg-muted/30">
      ...
      <div className="container relative z-10 max-w-5xl px-4 mx-auto">
        <h2 className="mb-12 text-3xl font-bold text-center sm:text-4xl">About Me</h2>
