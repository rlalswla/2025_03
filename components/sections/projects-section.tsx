  ...
  return (
    <AnimatedSection id="projects" className="relative w-full py-24 overflow-hidden" direction="right" delay={200}>
      ...
      <div className="container relative z-10 max-w-5xl px-4 mx-auto">
        <h2 className="mb-12 text-3xl font-bold text-center sm:text-4xl">My Projects</h2>
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <div
              key={project.id}
              onClick={(e) => handleCardClick(project.demoUrl, e)}
              className="overflow-hidden transition-all duration-500 rounded-lg group hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-2 bg-background/70 backdrop-blur-md border border-border cursor-pointer"
